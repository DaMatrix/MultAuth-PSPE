...
//this is a very hacky thing that will override the existing class in MCProtocolLib's code
//this lets any version of MC connect to the authentication server rather than only one
    ...
    public void packetReceived(PacketReceivedEvent event) {
            ...
            if(event.getPacket() instanceof HandshakePacket) {
                ...
                switch(packet.getIntent()) {
                    ...
                    case LOGIN:
                        ...
                        */
                        //don't bother checking client version, we'll never get far enough that it'll be important
        ...
        if(protocol.getSubProtocol() == SubProtocol.LOGIN) {
            if(event.getPacket() instanceof LoginStartPacket) {
                ...
                PrivateKey publicKey = KEY_PAIR.getPrivate();
                if(!Arrays.equals(this.verifyToken, packet.getVerifyToken(publicKey))) {
